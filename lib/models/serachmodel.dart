...
BookSearchModel bookModelFromJson(String str) => BookSearchModel.fromJson(json.decode(str));

String bookModelToJson(BookSearchModel data) => json.encode(data.toJson());

class BookSearchModel {
  List<BookDataSearch>? data;
  Meta? meta;

  BookSearchModel({this.data, this.meta});

  factory BookSearchModel.fromJson(Map<String, dynamic> json) {
    return BookSearchModel(
      data: json["data"] == null
          ? []
          : List<BookDataSearch>.from(json["data"]!.map((x) => BookDataSearch.fromJson(x))),
    );
  }
...
class BookDataSearch {
  ...
  factory BookDataSearch.fromJson(Map<String, dynamic> json) {
    return BookDataSearch(
      id: json["id"],
      attributes: json["attributes"] == null
          ? null
          : AttributesSearch.fromJson(json["attributes"]),
    );
  }
...
class AttributesSearch {
  ...
  factory AttributesSearch.fromJson(Map<String, dynamic> json) {
